...
export const metadata = pageMetadata({
  title: "Gearbox Specialist Near You — Klang Valley Coverage",
  description:
    "Find gearbox diagnosis and repair near you: Kuala Lumpur, Petaling Jaya, Shah Alam, Subang Jaya, Klang, Puchong, Cheras and across the Klang Valley.",
  path: "/locations",
});
      ...
      <header className="border-b border-line bg-panel">
        <div className="mx-auto max-w-7xl px-4 pb-14 pt-12 sm:px-6 sm:pt-16">
          ...
          <p className="mt-6 max-w-2xl text-[15px] leading-relaxed text-muted">
            Partner workshops across the Klang Valley — diagnosis-first, written warranty, wherever
            you drive.
          </p>
        </div>
      </header>
